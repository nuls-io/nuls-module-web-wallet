...
const cn = {
  ...
  "newConsensus": {
    ...
    "newConsensus8": "保证金不小于{min}并且不大于{max}",
  ...
  "ledger": {
    ledger1: '连接硬件钱包',
    ledger2: '选择希望用于NULS AI Wallet的硬件钱包',
    ledger3: '插入硬件钱包',
    ledger4: '将您的钱包直接连接到电脑。解锁Ledger并打开NULS AI 应用程序',
    ledger5: '连接中...',
    ledger6: '正在加载...',
    ledger7: '选择希望用于 Nuls AI Wallet 的账户',
    ledger8: '上一页',
    ledger9: '下一页',
    ledger10: '发送中',
    ledger11: '请在Ledger设备中确认签名',
    ledger12: '请解锁Ledger并打开NULS AI应用程序',
    ledger13: '关闭',
  },
  ...zhLocale
};
