...
const en = {
  ...
  "password": {
    ...
    "password2": "Cancel",
    "password3": "Confirm",
    "password4": "Remember Password (App close will clear)",
  },
  ...
  "transfer": {
    ...
    "transfer13": "The amount must be greater than 10",
  ...
  "newConsensus": {
    ...
    "newConsensus8": "Margin not less than {min} and not more than {max}",
  ...
  "nodeService": {
    ...
    "nodeService19": "This operation will remove the {apiUrl} node service, continue?",
    "nodeService20": "",
    "nodeService21": "Tips",
  ...
  "setAlias": {
    ...
    "setAlias2": "Setting aliases costs {number} ",
  ...
  "ledger": {
    ...
    ledger2: 'Select the hardware wallet you want to use with NULS AI Wallet',
    ledger3: 'Insert Ledger Wallet',
    ledger4: 'Connect your wallet directly to your computer. Unlock the Ledger and open the NULS AI App',
    ledger5: 'Connecting...',
    ledger6: 'Loading...',
    ledger7: 'Select the account you want to use for NULS AI Wallet',
    ledger8: 'Previous',
    ledger9: 'Next',
    ledger10: 'Sending...',
    ledger11: 'Please confirm the signature in the Ledger',
    ledger12: 'Please unlock the Ledger and open the NULS AI App',
    ledger13: 'Close',
  },
  ...enLocale
